package com.adjiekurniawan.sumbission5_dicoding.fragment;
...
import com.adjiekurniawan.sumbission5_dicoding.adapters.MovieAdapterFav;
...
import com.adjiekurniawan.sumbission5_dicoding.utils.RecyclerItemTouchHelper;
...
public class FragmentTabFavMovie extends Fragment implements RecyclerItemTouchHelper.RecyclerItemTouchHelperListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            favoriteList = new ArrayList<>(Objects.requireNonNull(savedInstanceState.<Favorite>getParcelableArrayList(CATEGORY_INTENT_MOVIE)));
    ...
    private static void sendUpdateFavoriteList(Context context)
    {
